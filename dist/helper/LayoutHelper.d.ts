declare class LayoutHelper {
    ...
    static mapElementPosition(wrapper: Record<string, HTMLDivElement | HTMLElement>, splitMode: "horizontal" | "vertical", cachedMappedSplitPanePosition: Record<string, Record<string, string | null> | null>): void;
