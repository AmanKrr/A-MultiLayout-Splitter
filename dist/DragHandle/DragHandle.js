...
function DragHandle({ mode, onMouseDown, onTouchStart, props, position, }) {
    ...
    function handleMouseOverChild(e) {
        var _a, _b;
        (_a = e.target.parentElement.firstChild) === null || _a === void 0 ? void 0 : _a.classList.remove("a-icon-hide");
        (_b = e.target.parentElement.lastChild) === null || _b === void 0 ? void 0 : _b.classList.remove("a-icon-hide");
    }
