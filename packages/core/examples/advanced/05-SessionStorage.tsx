/**
 * Advanced Example 5: Session Storage Persistence
 *
 * Demonstrates automatic persistence to sessionStorage.
  ...
  return (
    <div style={{ height: '100%', width: '100%' }}>
      <div style={{
        ...
        💾 Session Storage Enabled - Try refreshing!
      </div>
      ...
      >
        <div style={{ padding: '20px', background: '#e8f5e9', paddingTop: '60px' }}>
          ...
          <p style={{ marginTop: '20px', fontSize: '14px', opacity: 0.7 }}>
            * Uses sessionStorage (cleared when tab is closed)
          </p>
        </div>
        <div style={{ padding: '20px', background: '#f3e5f5', paddingTop: '60px' }}>
          <h2>Right Pane</h2>
          <p>The layout is automatically saved to sessionStorage.</p>
          <p>Perfect for maintaining user preferences during a session.</p>
          <h3>How it works:</h3>
          <ul>
            ...
            <li>Data cleared when tab/browser is closed</li>
          </ul>
        </div>
      </Split>
    </div>
