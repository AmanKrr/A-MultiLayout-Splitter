...
describe('Pane', () => {
  describe('Rendering', () => {
    it('renders with basic props', () => {
      const { container } = render(<Pane id="pane-0" size="50%" collapsed={false} minSize={10} maxSize={90} mode="horizontal" content={<div>Test Content</div>} />);
    ...
    it('applies correct data attributes', () => {
      const { container } = render(<Pane id="test-pane" size="30%" collapsed={false} minSize={20} maxSize={80} mode="horizontal" content={<div>Content</div>} />);
    ...
    it('renders content correctly', () => {
      ...
      const { getByTestId } = render(<Pane id="pane-0" size="50%" collapsed={false} minSize={0} maxSize={100} mode="horizontal" content={content} />);
  ...
  describe('Flex Basis', () => {
    it('applies correct flexBasis with percentage', () => {
      const { container } = render(<Pane id="pane-0" size="60%" collapsed={false} minSize={0} maxSize={100} mode="horizontal" content={<div>Content</div>} />);
    ...
    it('applies correct flexBasis with pixels', () => {
      const { container } = render(<Pane id="pane-0" size="200px" collapsed={false} minSize={0} maxSize={100} mode="horizontal" content={<div>Content</div>} />);
    ...
    it('falls back to 100% if size is undefined', () => {
      const { container } = render(<Pane id="pane-0" size={undefined as any} collapsed={false} minSize={0} maxSize={100} mode="horizontal" content={<div>Content</div>} />);
  ...
  describe('Collapsed State', () => {
    it('applies a-split-hidden class when collapsed', () => {
      const { container } = render(<Pane id="pane-0" size="50%" collapsed={true} minSize={0} maxSize={100} mode="horizontal" content={<div>Content</div>} />);
    ...
    it('does not apply a-split-hidden class when not collapsed', () => {
      const { container } = render(<Pane id="pane-0" size="50%" collapsed={false} minSize={0} maxSize={100} mode="horizontal" content={<div>Content</div>} />);
